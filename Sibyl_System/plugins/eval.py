...
@System.on(system_cmd(pattern=r"edith (exec|xecute|x|ex)"))
async def run(event):
...
@System.on(system_cmd(pattern=r"edith (ev|eva|eval|py)"))
...
EXAMPLE - `!edith x print("OWO")`
Run code using **eval**
CMD - <ev or eva or eval or py> your code
EXAMPLE - `!edith eval 1 + 1`
"""
